...
/* -------------------------------------------------------------------------- *
 * OpenSim Moco: RegisterTypes_osimMocoJumpGoal.h                     *
 * -------------------------------------------------------------------------- *
...
class osimMocoJumpGoalInstantiator {
public:
    osimMocoJumpGoalInstantiator();
private:
    void registerDllClasses();
};

#endif // MOCO_REGISTERTYPES_OSIMMOCOJUMPGOAL_H
